...
public class SliderDemo extends Application
{
	...
	public void start(Stage stage)
	{
		...
		Slider vertSlider = new Slider(0, 300, 0);
		...
		Slider horizSlider = new Slider(0, 300, 0);
		...
		horizSlider.valueProperty().bind(vertSlider.valueProperty());
		...
		horizBox.getChildren().addAll(rect, horizSlider, horizLabel);
